  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne2" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne2">
      <div class="panel-body">
        - Ask for the risks of a tsunami in your location<br>
        - Ask for the past tsunami in your location<br>
        - If you are in a sensitive area, group everything you could need<br>
        - Talk about the risks with your family
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseTwo2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo2">
      <div class="panel-body">
        - Leave your stuff<br>
        - Move to a high place (far from the coast)<br>
        - If you are stuck in the water, try to grab something floating
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseThree2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree2">
      <div class="panel-body">
        - Stay aware of other waves that can follow the first one<br>
        - Listen to the information (radio / tv)<br>
        - Wait for authorities safety instructions
      </div>
    </div>
  </div>
</div>
