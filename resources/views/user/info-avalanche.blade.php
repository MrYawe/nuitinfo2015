  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne5" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne5">
      <div class="panel-body">
        - Stay informed about the level of risk<br>
        - Get a device made for avalanches (this will help the rescue team)
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseTwo5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo5">
      <div class="panel-body">
        - If you are outside the avalanche : stay safe and try to go inside<br>
        - If you are inside the avalanche : Try to allow you to breathe, try to go out the snow
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseThree5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree5">
      <div class="panel-body">
        - If you were not in the avalanche you can help the rescue team
      </div>
    </div>
  </div>
</div>
