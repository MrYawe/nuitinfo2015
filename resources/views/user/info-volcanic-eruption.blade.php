  ...
  <div class="panel panel-default">
    ...
    <div id="collapseOne6" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne6">
      <div class="panel-body">
        - Listen to the radio, be aware of the government instructions<br>
        - Prepare medical equipment.<br>
        - Store water<br>
        - Get other miscellaneous items (helmet, dust masks)
      </div>
    </div>
  </div>
  <div class="panel panel-default">
    ...
    <div id="collapseTwo6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo6">
      <div class="panel-body">
        - Stay in buildings<br>
        - Avoid to use your phone<br>
        - Protect sensitive people from dust / smoke
      </div>
    </div>
  </div>
</div>
